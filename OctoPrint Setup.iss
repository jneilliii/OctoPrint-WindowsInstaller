...
Filename: "{app}\venv\Scripts\pip.exe"; Parameters: "install --upgrade octoprint=={#OctoPrintVersion}"; WorkingDir: "{app}"; Flags: skipifdoesntexist runhidden; Description: "Install OctoPrint"; StatusMsg: "Installing OctoPrint into venv"; Components: initial_instance
