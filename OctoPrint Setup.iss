...
Filename: "{app}\WPy64-31700\scripts\python.bat"; Parameters: "-m pip install https://github.com/jneilliii/OctoPrint-go2rtc/archive/master.zip"; WorkingDir: "{app}"; Flags: runascurrentuser postinstall; Description: "Install go2rtc plugin in OctoPrint"; StatusMsg: "Adding go2rtc plugin in OctoPrint"; Components: initial_instance add_instance; Tasks: include_go2rtc
